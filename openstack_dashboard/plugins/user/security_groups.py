...
LOG = logging.getLogger('openstack_dashboard.dash.views.security_groups')
...
def index(request, tenant_id):
    ...
    return shortcuts.render_to_response(topbar + '/security_group_view.html', {
...
def edit_rules(request, tenant_id, security_group_id):
    ...
    return shortcuts.render_to_response(topbar + '/security_group_edit_rules.html', {
